...
`.tasks.md` и `.answers.md` для самопроверки. Общий план — [../ru.PLAN.md](../ru.PLAN.md).
...
| # | Топик | Задачи | Статус |
|---|---|---|---|
| 01 | [Уровни изоляции](./ru.01-isolation-levels.md) | [tasks](./ru.01-isolation-levels.tasks.md) · [answers](./ru.01-isolation-levels.answers.md) | ✅ |
...
[system-design/03-reliability-patterns](../system-design/ru.03-reliability-patterns.md)

...
конспект-план всей подготовки — в [../ru.PLAN.md](../ru.PLAN.md).
...
| # | Файл | О чём | Статус |
|---|---|---|---|
| 01 | [foundations](./ru.01-foundations.md) | распределённые системы, CAP/PACELC, трейд-офф-мышление | ✅ |
| 02 | [event-driven-messaging](./ru.02-event-driven-messaging.md) | зачем event-driven, продюсер/брокер/консьюмер, семантики доставки | ✅ |
| 03 | [reliability-patterns](./ru.03-reliability-patterns.md) | ack/nack, идемпотентность, outbox, retries+backoff, DLQ, rate limiting, crash recovery | ✅ |
| 04 | [kafka-vs-rabbitmq](./ru.04-kafka-vs-rabbitmq.md) | лог vs очередь, offset/партиции vs exchange/competing consumers | ✅ |
...
| # | Файл | О чём | Статус |
|---|---|---|---|
| 05 | [scaling](./ru.05-scaling.md) | вертикаль/горизонталь Node, cluster/PM2, stateless, worker_threads | ✅ |
| 06 | [scaling-data](./ru.06-scaling-data.md) | балансировка (L4/L7), репликация (leader/follower, lag), шардинг (shard key) | ✅ |

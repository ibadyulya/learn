...
delivery guarantees exist. Builds on [01-foundations](./en.01-foundations.md);
next — how to make it reliable in
[03-reliability-patterns](./en.03-reliability-patterns.md).

> 🌐 Russian version: [ru.02-event-driven-messaging.md](./ru.02-event-driven-messaging.md)

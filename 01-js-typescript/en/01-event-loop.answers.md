...
First try it yourself in [01-event-loop.tasks.md](./01-event-loop.tasks.md), then check against these.

> 🌐 Russian version: [01-event-loop.answers.md](../ru/01-event-loop.answers.md)

...
[03-advanced-typescript.answers.md](./03-advanced-typescript.answers.md). Test yourself by mentally substituting an
example, like in the `ExtractByType` walkthrough.

> 🌐 Russian version: [03-advanced-typescript.tasks.md](../ru/03-advanced-typescript.tasks.md)

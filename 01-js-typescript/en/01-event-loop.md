...
> 🌐 Russian version: [01-event-loop.md](../ru/01-event-loop.md)
...
See [01-event-loop.tasks.md](./01-event-loop.tasks.md) — trace tasks. Solutions in [01-event-loop.answers.md](./01-event-loop.answers.md).

...
Answer in your own words, then check against [02-modules-cjs-esm.answers.md](./02-modules-cjs-esm.answers.md).

> 🌐 Russian version: [02-modules-cjs-esm.tasks.md](../ru/02-modules-cjs-esm.tasks.md)

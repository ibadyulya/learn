...
Answer in your own words, then check against [en.02-modules-cjs-esm.answers.md](./en.02-modules-cjs-esm.answers.md).

> 🌐 Russian version: [ru.02-modules-cjs-esm.tasks.md](./ru.02-modules-cjs-esm.tasks.md)

...
> 🌐 Russian version: [ru.02-modules-cjs-esm.md](./ru.02-modules-cjs-esm.md)
...
See [en.02-modules-cjs-esm.tasks.md](./en.02-modules-cjs-esm.tasks.md) — comprehension questions. Solutions — in [en.02-modules-cjs-esm.answers.md](./en.02-modules-cjs-esm.answers.md).

...
> 🌐 English version: [03-advanced-typescript.tasks.md](../en/03-advanced-typescript.tasks.md)

Реализуй тип сам, без подсказок, потом сверься с [03-advanced-typescript.answers.md](./03-advanced-typescript.answers.md).

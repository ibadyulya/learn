...
First try it yourself in [en.01-event-loop.tasks.md](./en.01-event-loop.tasks.md), then check against these.

> 🌐 Russian version: [ru.01-event-loop.answers.md](./ru.01-event-loop.answers.md)

...
> 🌐 Russian version: [ru.03-advanced-typescript.md](./ru.03-advanced-typescript.md)
...
See [en.03-advanced-typescript.tasks.md](./en.03-advanced-typescript.tasks.md) — implementation tasks. Solutions — in [en.03-advanced-typescript.answers.md](./en.03-advanced-typescript.answers.md).

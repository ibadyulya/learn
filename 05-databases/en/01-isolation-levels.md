...
Self-check tasks — [01-isolation-levels.tasks.md](./01-isolation-levels.tasks.md),
solutions — [01-isolation-levels.answers.md](./01-isolation-levels.answers.md).

> 🌐 Russian version: [01-isolation-levels.md](../ru/01-isolation-levels.md)

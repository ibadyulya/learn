...
Self-check tasks — [en.01-isolation-levels.tasks.md](./en.01-isolation-levels.tasks.md),
solutions — [en.01-isolation-levels.answers.md](./en.01-isolation-levels.answers.md).

> 🌐 Russian version: [ru.01-isolation-levels.md](./ru.01-isolation-levels.md)

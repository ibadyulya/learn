...
[02](./en.02-event-driven-messaging.md) and
[03](./en.03-reliability-patterns.md) maps onto two concrete technologies. The
main point — not "features", but **two different worlds by nature**; everything
follows from that nature.

> 🌐 Russian version: [ru.04-kafka-vs-rabbitmq.md](./ru.04-kafka-vs-rabbitmq.md)
...
## How to choose (the trade-off from [01-foundations](./en.01-foundations.md))

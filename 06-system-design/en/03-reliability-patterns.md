...
[02-event-driven-messaging](./02-event-driven-messaging.md); Kafka/Rabbit
concepts — in [04-kafka-vs-rabbitmq](./04-kafka-vs-rabbitmq.md).

> 🌐 Russian version: [03-reliability-patterns.md](../ru/03-reliability-patterns.md)

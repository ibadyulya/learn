...
[02](./02-event-driven-messaging.md) and
[03](./03-reliability-patterns.md) maps onto two concrete technologies. The
main point — not "features", but **two different worlds by nature**; everything
follows from that nature.

> 🌐 Russian version: [04-kafka-vs-rabbitmq.md](../ru/04-kafka-vs-rabbitmq.md)
...
## How to choose (the trade-off from [01-foundations](./01-foundations.md))

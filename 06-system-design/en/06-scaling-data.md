...
Block B, a continuation of [05-scaling](./05-scaling.md). How to scale beyond
the stateless layer — traffic and, most importantly, **data**.

> 🌐 Russian version: [06-scaling-data.md](../ru/06-scaling-data.md)
...
A deeper look than [05](./05-scaling.md). At what level it works (they love to
ask):

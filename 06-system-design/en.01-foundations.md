...
[02-event-driven-messaging](./en.02-event-driven-messaging.md),
[03-reliability-patterns](./en.03-reliability-patterns.md) and
[04-kafka-vs-rabbitmq](./en.04-kafka-vs-rabbitmq.md).

> 🌐 Russian version: [ru.01-foundations.md](./ru.01-foundations.md)
